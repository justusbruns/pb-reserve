...
const css = {
  code: '.mapboxgl-ctrl-geocoder{min-width:100%;font-size:16px;line-height:20px;font-family:"Inter", sans-serif}.mapboxgl-ctrl-geocoder--input{height:36px;padding:6px 35px;border:1px solid #C9DA9A;border-radius:4px;background-color:#326334;color:#C9DA9A}.mapboxgl-ctrl-geocoder--input:focus{outline:none;border-color:#C9DA9A}.mapboxgl-ctrl-geocoder--icon{fill:#C9DA9A}.mapboxgl-ctrl-geocoder--button{background:#326334}.mapboxgl-ctrl-geocoder--suggestion{color:#326334;font-family:"Inter", sans-serif}.mapboxgl-ctrl-geocoder--suggestion-title{font-weight:bold}.mapboxgl-ctrl-geocoder--suggestion:hover{background-color:#C9DA9A}',
  map: `{"version":3,"file":"+layout.svelte","sources":["+layout.svelte"],"sourcesContent":["<script>\\n  import { setContext } from 'svelte';\\n  import translations from '../translations';\\n  import '../styles.css';\\n  import 'mapbox-gl/dist/mapbox-gl.css';\\n\\n  /** @type {import('./$types').LayoutData} */\\n  export let data;\\n\\n  // Verify required data is present\\n  if (!data || !data.mapboxToken || !data.PUBLIC_API_TOKEN) {\\n    throw new Error('Required configuration is missing');\\n  }\\n\\n  // Function to determine the current language based on the URL\\n  function getCurrentLanguage() {\\n    if (typeof window !== 'undefined') {\\n      return window.location.pathname.startsWith('/en') ? 'en' : 'nl';\\n    }\\n    return 'nl';\\n  }\\n\\n  let currentLanguage = getCurrentLanguage();\\n\\n  // Update language when URL changes\\n  if (typeof window !== 'undefined') {\\n    window.addEventListener('popstate', () => {\\n      currentLanguage = getCurrentLanguage();\\n      setContext('translations', translations[currentLanguage]);\\n    });\\n  }\\n\\n  // Make mapbox token available to all components\\n  setContext('mapboxToken', data.mapboxToken);\\n  // Make API token available to all components\\n  setContext('apiToken', data.PUBLIC_API_TOKEN);\\n  // Make translations available to all components based on current language\\n  setContext('translations', translations[currentLanguage]);\\n<\/script>\\n\\n<style>\\n  /* Mapbox Geocoder styles */\\n  :global(.mapboxgl-ctrl-geocoder) {\\n    min-width: 100%;\\n    font-size: 16px;\\n    line-height: 20px;\\n    font-family: \\"Inter\\", sans-serif;\\n  }\\n\\n  :global(.mapboxgl-ctrl-geocoder--input) {\\n    height: 36px;\\n    padding: 6px 35px;\\n    border: 1px solid #C9DA9A;\\n    border-radius: 4px;\\n    background-color: #326334;\\n    color: #C9DA9A;\\n  }\\n\\n  :global(.mapboxgl-ctrl-geocoder--input:focus) {\\n    outline: none;\\n    border-color: #C9DA9A;\\n  }\\n\\n  :global(.mapboxgl-ctrl-geocoder--icon) {\\n    fill: #C9DA9A;\\n  }\\n\\n  :global(.mapboxgl-ctrl-geocoder--button) {\\n    background: #326334;\\n  }\\n\\n  :global(.mapboxgl-ctrl-geocoder--suggestion) {\\n    color: #326334;\\n    font-family: \\"Inter\\", sans-serif;\\n  }\\n\\n  :global(.mapboxgl-ctrl-geocoder--suggestion-title) {\\n    font-weight: bold;\\n  }\\n\\n  :global(.mapboxgl-ctrl-geocoder--suggestion:hover) {\\n    background-color: #C9DA9A;\\n  }\\n</style>\\n\\n<slot />\\n"],"names":[],"mappings":"AA0CU,uBAAyB,CAC/B,SAAS,CAAE,IAAI,CACf,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,OAAO,CAAC,CAAC,UACxB,CAEQ,8BAAgC,CACtC,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,OACT,CAEQ,oCAAsC,CAC5C,OAAO,CAAE,IAAI,CACb,YAAY,CAAE,OAChB,CAEQ,6BAA+B,CACrC,IAAI,CAAE,OACR,CAEQ,+BAAiC,CACvC,UAAU,CAAE,OACd,CAEQ,mCAAqC,CAC3C,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,OAAO,CAAC,CAAC,UACxB,CAEQ,yCAA2C,CACjD,WAAW,CAAE,IACf,CAEQ,yCAA2C,CACjD,gBAAgB,CAAE,OACpB"}`
};
function getCurrentLanguage() {
  if (typeof window !== "undefined") {
    return window.location.pathname.startsWith("/en") ? "en" : "nl";
